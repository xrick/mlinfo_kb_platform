# utils/chunk_nbinfo_v2_20250915.py
# utils/chunk_nbinfo_v1_20250910 copy.py
...
def gen_all_nbinfo_tb(csv_directory: str = 'data/raw/EM_New TTL_241104_AllModelsParsed', db_path: str = 'all_nbinfo_v2.db', collection_name: str = 'nbtypes_collection') -> bool:
    """
    ...
    Args:
        ...
        db_path (str): Path for the DuckDB database file. Default: 'all_nbinfo_v2.db'
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # Connect to Milvus (assume default connection parameters)
                ...
                fields = [
                    ...
                    FieldSchema(name="embedding", dtype=DataType.FLOAT_VECTOR, dim=384)  # sentence-transformers default dim
                ]
                
                schema = CollectionSchema(fields=fields, description="Notebook specifications collection")
                collection = Collection(name=collection_name, schema=schema)
                logger.info(f"Created new Milvus collection: {collection_name}")
                
            except Exception as milvus_e:
                logger.warning(f"Milvus collection management failed: {str(milvus_e)}")
                # Continue with database operation even if Milvus fails
...
def embed_all_nbinfo_to_collection(
    csv_directory: str = 'data/raw/EM_New TTL_241104_AllModelsParsed',
